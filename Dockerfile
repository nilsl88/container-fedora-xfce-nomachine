...
# Install NoMachine
ARG NOMACHINE_AMD64_RPM="nomachine_9.8.2_1_x86_64.rpm"
ARG NOMACHINE_ARM64_RPM="nomachine_9.8.2_1_aarch64.rpm"
ARG NOMACHINE_URL_AMD64="https://download.nomachine.com/download/9.8/Linux/${NOMACHINE_AMD64_RPM}"
ARG NOMACHINE_URL_ARM64="https://download.nomachine.com/download/9.8/Arm/${NOMACHINE_ARM64_RPM}"
